...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Availability.volunteer'
        db.add_column(u'volunteer_availability', 'volunteer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='availability', to=orm['entity.Entity']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Availability.volunteer'
        db.delete_column(u'volunteer_availability', 'volunteer_id')
