...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Communication.date_time'
        db.delete_column(u'tracking_communication', 'date_time')

        # Adding field 'Communication.date'
        db.add_column(u'tracking_communication', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date.today),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Communication.date_time'
        db.add_column(u'tracking_communication', 'date_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 28, 0, 0)),
                      keep_default=False)

        # Deleting field 'Communication.date'
        db.delete_column(u'tracking_communication', 'date')
